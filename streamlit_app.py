...
if len(df) < 60:
    ...
    # Macro directional proxy: inverse VIX + inverse DXY for last bar sign
    ...
    fund_sig = 0  # placeholder; wire real revisions/sentiment APIs
